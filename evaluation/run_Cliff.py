...
parser.add_argument('--predictor', type=str, default='Cliff_probes', metavar='N',
                    choices=['Cliff_probes', 'Cliff_probes_finetune'],
                    help="downstream predictor name: 'Cliff_probes' for a frozen encoder, "
                         "'Cliff_probes_finetune' for end-to-end fine-tuning")
...
def build_model(args):
    ...
    if args.predictor == 'Cliff_probes':
        probe_model = models.Cliff_probe(qcGEM_model = model,
    ...
    elif args.predictor == 'Cliff_probes_finetune':
        probe_model = models.Cliff_probe_finetune(qcGEM_model = model,
                                        global_emb_dim = args.global_dim, node_emb_dim = args.node_dim, edge_emb_dim = args.edge_dim,
                                        device = args.device, task_name = args.dataset)
    else:
