...
class qcGEM_example(InMemoryDataset):
    ...
    def __init__(self, root, dataset=None, split_mode='random', split_seed=0, transform=None, pre_transform=None, pre_filter=None):
        ...
        super(qcGEM_example, self).__init__(root, transform, pre_transform, pre_filter)
    ...
    @property
    def processed_dir(self):
        return f'{self.root}/processed/{self.dataset}_example'
